                ...
                <Col>
                    <Card style={cardStyle}>
                        <Card.Body style={headerStyle}>
                            <h2 className="text-center mb-3">Welcome back {user.firstName}!</h2>
                ...
                <Col md={9}>
                    <Card style={cardStyle}>
                        <Card.Body>
                            ...
                            {activeTab === 'stats' && (
                                <>
                                    <h4><BarChart2 className="me-2" /> Statistics</h4>
                                    <Row>
                                        <Col md={4}>
                                            <Card className="text-center mb-3" style={{background: '#E3F2FD'}}>
                                                <Card.Body>
                                        ...
                                        <Col md={4}>
                                            <Card className="text-center mb-3" style={{background: '#E1F5FE'}}>
                                                <Card.Body>
                                        ...
                                        <Col md={4}>
                                            <Card className="text-center mb-3" style={{background: '#E0F7FA'}}>
                                                <Card.Body>
